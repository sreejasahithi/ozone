...
public class ContainerOperationClient implements ScmClient {
  ...
  public ContainerOperationClient(OzoneConfiguration conf, NodeIdHolder holder) throws IOException {
    this.configuration = conf;
    if (holder != null) {
      storageContainerLocationClient = newContainerRpcClientForNode(conf, holder);
    } else {
  ...
  public static StorageContainerLocationProtocol newContainerRpcClientForNode(
      ConfigurationSource configSource, NodeIdHolder holder) {
    return HAUtils.getScmContainerClientForNode(configSource, holder);
  }
